...
_bodyPartText = (call FUNC(getSelectedBodyPart_CMS));
_bodyPartN = [_bodyPartText] call FUNC(getBodyPartNumber_CMS);
...
[_openWounds,_bandagedWounds] spawn FUNC(updateBodyImg_CMS);
...
if (([_targetObj, _bodyPartText] call FUNC(hasTourniquetAppliedTo_CMS))) then {
