...
if(_warn) then {
	diag_log text format["Ammo class %1 lacks proper explosive properties definitions for sys_frag!", _shellType]; //TODO: turn this off when we get closer to release
};
