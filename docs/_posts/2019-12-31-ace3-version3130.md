...
Most of the changes described below can be better controlled and fine tuned (or even disabled) to better suit the needs individual users and communities.
...
The [feedback survey](https://forms.gle/5pKeXMJ5hfZYjuxZ6) is still available and we will continue utilize user feedback to balance the new medical system and fix any issues.
