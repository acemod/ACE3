...
> configfile >> "CfgAmmo" >> "**(Class Name bullet)** at the top left of the Range Card" >> "ACE_ballisticCoefficients"

> configfile >> "CfgAmmo" >> "**(Class Name bullet)** at the top left of the Range Card" >> "ACE_dragModel"
