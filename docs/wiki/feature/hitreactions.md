...
Note that the shot needs to inflict a certain amount of damage to make the unit fall, a small cut won't make the unit stumble. This can be disabled per-unit by setting "ace_hitreactions_allowFalling" to false on the unit.
