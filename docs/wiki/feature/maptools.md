...
- When a new marker (Local or Group Channel) on the inner circle of the Plotting board is created, the marker will move accordingly when the Plotting Board gets moved or rotated.
