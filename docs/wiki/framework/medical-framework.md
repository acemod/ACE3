...
| 1  | `[[0.5, "Body", 1, "HitChest"], [0.3, "Head", 0.6, "HitHead"]]` | 0.5 damage to body (was 1 before armor), 0.3 damage to head (was 0.6 before armor), hitpoint that actually took the hit |
