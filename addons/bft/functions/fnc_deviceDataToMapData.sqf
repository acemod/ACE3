...
private [ "_deviceID", "_sideInformation", "_assignableInformation", "_owner","_deviceClass", "_encryptionKeys", "_access", "_typeIconPath", "_sizeIconPath", "_callsign","_groupID", "_position"];
...
[_deviceID, _deviceID, _typeIconPath, _sizeIconPath, _position, _encryptionKeys, _groupID, _deviceClass];
