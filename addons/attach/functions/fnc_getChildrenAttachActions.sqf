...

{
    if !(_x in _listed) then {
        ...
        if (getText (_item >> "ACE_Attachable") != "") then {
            ...
            _action = [_x, _displayName, _picture, {[{_this call FUNC(attach)}, _this] call CFUNC(execNextFrame)}, {_this call FUNC(canAttach)}, {}, [_x]] call EFUNC(interact_menu,createAction);
