class CfgVehicles {
	...
	class ACE_MACS_Sleeve_F: ThingX {   
		...
		author = ECSTRING(common,ACETeam);
		model=PATHTOF(modular_charges\macs_charge_sleeve_F.p3d);
		icon=PATHTOF(m198_loading_tray\data\ui\map_pushrod_ca.paa);
		picture=PATHTOF(m198_loading_tray\data\ui\pushrod_equip_ca.paa);
		vehicleClass = "Static";
	};
	class ACE_MACS_M231_Pallet_F: ThingX {   
		...
		author = ECSTRING(common,ACETeam);
		model=PATHTOF(modular_charges\macs_pallet_m231_F.p3d);
		icon=PATHTOF(m198_loading_tray\data\ui\map_pushrod_ca.paa);
		picture=PATHTOF(m198_loading_tray\data\ui\pushrod_equip_ca.paa);
		vehicleClass = "Static";
	...
	class ACE_MACS_M232_Pallet_F: ACE_MACS_M231_Pallet_F {   
		...
		author = ECSTRING(common,ACETeam);
		model=PATHTOF(modular_charges\macs_pallet_m232_F.p3d);
		icon=PATHTOF(m198_loading_tray\data\ui\map_pushrod_ca.paa);
		picture=PATHTOF(m198_loading_tray\data\ui\pushrod_equip_ca.paa);
		vehicleClass = "Static";
	};
	class ACE_MACS_M231_Bundle_F: ReammoBox_F {   
		scope = 2;
        scopeCurator = 2;
		displayName = "MACS M231 Artillery Charges (Bundle)";
		author = ECSTRING(common,ACETeam);
		model=PATHTOF(modular_charges\macs_bundle_m231_F.p3d);
		icon=PATHTOF(m198_loading_tray\data\ui\map_pushrod_ca.paa);
		picture=PATHTOF(m198_loading_tray\data\ui\pushrod_equip_ca.paa);
		vehicleClass = "Static";
		
		class TransportItems {
            MACRO_ADDITEM(ACE_MACS_M231_Charge_F,24);
        };
		
	};
	class ACE_MACS_M232_Bundle_F: ReammoBox_F {   
		scope = 2;
        scopeCurator = 2;
		displayName = "MACS M232 Artillery Charges (Bundle)";
		author = ECSTRING(common,ACETeam);
		model=PATHTOF(modular_charges\macs_bundle_m232_F.p3d);
		icon=PATHTOF(m198_loading_tray\data\ui\map_pushrod_ca.paa);
		picture=PATHTOF(m198_loading_tray\data\ui\pushrod_equip_ca.paa);
		vehicleClass = "Static";

		class TransportItems {
            MACRO_ADDITEM(ACE_MACS_M232_Charge_F,30);
        };
	};
