...
class GVAR(DISPLAY_NAME) {
    ...
    class controls {
        ...
        */
        ...
        // ---------- MAIN MENU -----------
        class menuContainer: EGVAR(bft_devices,RscControlsGroup) {
            idc = IDC_GROUP_MENU;
            ...
            class Scrollbar {};
            class controls {
                class menuBackground: EGVAR(bft_devices,IGUIBack) {
                    IDC_COUNTER
                    x = 0;
                    y = 0;
                    w = pxToScreen_W(GD300_OSD_MENU_W);
                ...
                class btnTextonoff: EGVAR(bft_devices,RscButton) {
                    IDC_COUNTER
        ...
        class MESSAGE: EGVAR(bft_devices,RscControlsGroup) {
            ...
            class Scrollbar {};
            class controls {
                class msgListbox: EGVAR(bft_devices,RscListbox) {
                    idc = IDC_MSG_LIST;
                    style = LB_MULTI;
                ...
                class msgTxt: EGVAR(bft_devices,RscEdit) {
                    idc = IDC_MSG_CONTENT;
                    htmlControl = true;
                    style = ST_MULTI;
                    lineSpacing = 0.2;
                ...
                class deletebtn: EGVAR(bft_devices,RscButton) {
                ...
                class toCompose: EGVAR(bft_devices,RscButton) {
                    IDC_COUNTER
        ...
        // ---------- MESSAGING COMPOSE -----------
        class COMPOSE: EGVAR(bft_devices,RscControlsGroup) {
            ...
            class controls {
                ...
                class playerlistbox: EGVAR(bft_devices,RscListbox) {
                ...
                class sendbtn: EGVAR(bft_devices,RscButton) {
                    idc = IDC_MSG_BTNSEND;
                ...
                class edittxtbox: EGVAR(bft_devices,RscEdit) {
                    idc = IDC_MSG_COMPOSE;
                    htmlControl = true;
                    style = ST_MULTI;
                    lineSpacing = 0.2;
                ...
                class toRead: EGVAR(bft_devices,RscButton) {
                    IDC_COUNTER
