...
class GVAR(GD300_RscText): EGVAR(bft_devices,RscText) {
    style = ST_CENTER;
...
class GVAR(GD300_RscMapControl): EGVAR(bft_devices,RscMapControl) {
    idc = IDC_SCREEN;
    onDraw = onDrawBFT(0);
...
class GVAR(GD300_background): EGVAR(bft_devices,RscPicture) {
    idc = IDC_BACKGROUND;
...
class GVAR(GD300_btnBack): EGVAR(bft_devices,RscButtonInv) {
    x = pxToScreen_X(1609);
    y = pxToScreen_Y(806);
    w = pxToScreen_W(102);
    h = pxToScreen_H(102);
...
class GVAR(GD300_btnPower): EGVAR(bft_devices,RscButtonInv) {
    x = pxToScreen_X(1583);
    y = pxToScreen_Y(1407);
    w = pxToScreen_W(107);
    h = pxToScreen_H(48);
...
class GVAR(GD300_header): EGVAR(bft_devices,RscPicture) {
    IDC_COUNTER
...
class GVAR(GD300_on_screen_battery): EGVAR(bft_devices,RscPicture) {
    IDC_COUNTER
...
class GVAR(GD300_windowsBG): EGVAR(bft_devices,RscPicture) {
    idc = IDC_WIN_BACK;
