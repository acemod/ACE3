class CfgWeapons
{
	...
	{
		displayName = "MRE Type One";
		picture = QPATHTOF(data\icons\mre_type1.paa);
		model = QPATHTOF(data\mre.p3d);
		descriptionShort = "A delicious Meal Ready to Eat (chicken with rice)";
	...
	{
		displayName = "MRE Type Two";
		picture = QPATHTOF(data\icons\mre_type2.paa);
		model = QPATHTOF(data\mre.p3d);
		descriptionShort = "A delicious Meal Ready to Eat (steak and potato)";
