class CfgVehicles {
	...
	class Land_NetFence_01_m_4m_F: Wall_F { GVAR(isFence) = 1; };
    class Land_NetFence_01_m_8m_F: Wall_F { GVAR(isFence) = 1; };
	...
	class Land_WiredFence_01_4m_F: Wall_F { GVAR(isFence) = 1; };
    class Land_WiredFence_01_8m_F: Wall_F { GVAR(isFence) = 1; };
	class Land_WiredFence_01_16m_F: Wall_F { GVAR(isFence) = 1; };
	...
	class Land_Slums01_8m: Wall_F { GVAR(isFence) = 1; };
