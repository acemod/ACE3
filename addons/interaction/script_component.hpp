...
#define MACRO_DOOR_REACH_DISTANCE ((AGLToASL positionCameraToWorld [0, 0, 0]) vectorDistance getPosASL (ACE_player modelToWorldWorld (ACE_player selectionPosition "Head"))) + 2
