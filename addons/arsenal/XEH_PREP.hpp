...
PREP(verifyLoadout);
PREP(wrapper_arsenal);
PREP(wrapper_addVirtualBackpackCargo);
PREP(wrapper_addVirtualItemCargo);
PREP(wrapper_addVirtualMagazineCargo);
PREP(wrapper_addVirtualWeaponCargo);
PREP(wrapper_removeVirtualBackpackCargo);
PREP(wrapper_removeVirtualItemCargo);
PREP(wrapper_removeVirtualMagazineCargo);
PREP(wrapper_removeVirtualWeaponCargo);
