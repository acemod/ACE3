...
private _selectedItem = switch (true) do {
    ...
    case (_ctrlIDC in [IDC_buttonPrimaryWeapon, IDC_buttonHandgun, IDC_buttonSecondaryWeapon]): {
        ...
        } forEach ((GVAR(virtualItems) select IDX_VIRT_WEAPONS) select _index);
    ...
    default {
        ...
        switch (_ctrlIDC) do {
            ...
            case IDC_buttonNVG: {
                {
                    ["CfgWeapons", _x, _ctrlPanel] call FUNC(addListBoxItem);
                } forEach (GVAR(virtualItems) select IDX_VIRT_NVG);
            ...
            case IDC_buttonBinoculars: {
                {
                    ["CfgWeapons", _x, _ctrlPanel] call FUNC(addListBoxItem);
                } forEach (GVAR(virtualItems) select IDX_VIRT_BINO);
            ...
            case IDC_buttonGPS: {
                {
                    ["CfgWeapons", _x, _ctrlPanel] call FUNC(addListBoxItem);
                } forEach (GVAR(virtualItems) select IDX_VIRT_COMMS);
            ...
            case IDC_buttonFace: {
                ...
                } forEach (uiNamespace getVariable [QGVAR(faceCache), createHashMap]);
...
// Sort
[_display, _control, _display displayCtrl IDC_sortLeftTab] call FUNC(fillSort);
