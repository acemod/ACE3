...
params ["_object", "_sensorType", "_sensorVector", "_sensorAngle", "_sensorLookVector", "_sensorLookAngle", "_range", "_sensorMisc", "_function", "_miscFunction"];
...
//hint format ["%1\n%2\n%3", _sensorVector, _sensorLookVector, _sensorVector vectorDotProduct _sensorLookVector];
...
private _returns = [_object, _pos, _sensorLookVector, _sensorLookAngle/2, _range, _sensorMisc] call (missionNamespace getvariable _miscFunction);
...
private _returns = [_object, _pos, _sensorLookVector, _sensorLookAngle/2, _range, _sensorMisc] call (ace_guidance_fnc_sensorEO);
//hint str _returns;
