 ...
 * 6: Exceptions for checking ace_common_fnc_canInteractWith (works like a permission system, if there is an exception, e.g. "isNotSwimming" in the exceptions, the progress bar will work while swimming) <ARRAY> (default: [])
