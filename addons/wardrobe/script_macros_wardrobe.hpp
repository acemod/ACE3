...
#define UNIFORM_KNEEPADS(variantKneepadsOn,variantKneepadsOff)\
BASIC(variantKneepadsOn,variantKneepadsOff,ACEWARDROBE(base_U_kneepads_on),ACEWARDROBE(base_U_kneepads_off))
