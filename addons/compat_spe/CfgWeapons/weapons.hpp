...
class SPE_FM_24_M29: SPE_LMG {
    ...
    EGVAR(overheating,allowSwapBarrel) = 0;
    EGVAR(overheating,dispersion) = 0.25;
    EGVAR(overheating,barrelMass) = 3; // Estimated to be similar to the Bren or heavier
};
...
class SPE_FG42_E: SPE_RIFLE { // Closed bolt in semi-auto, open bolt in full-auto
    ...
    ACE_barrelTwist = 240;
    ACE_barrelLength = 500;
    EGVAR(overheating,barrelMass) = 1.3; // Estimated to be similar to K98 or heavier
};
...
class SPE_MP35: SPE_SMG {
    ...
    EGVAR(overheating,barrelMass) = 0.6; // Estimated to be similar to MP40 or heavier
};
