...
if ((isNull curatorCamera) && {
    !([ACE_player, objNull, ["isNotInside","isNotDragging", "isNotCarrying", "isNotSwimming", "notOnMap", "isNotEscorting", "isNotSurrendering", "isNotSitting", "isNotOnLadder"]] call CFUNC(canInteractWith))
}) exitWith {false};
...
["interactMenuOpened", [_menuType]] call CFUNC(localEvent);
