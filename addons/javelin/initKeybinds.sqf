...
["localize ELSTRING(common,ACEConfigCategoryWeapons)", QGVAR(lockTarget), localize LSTRING(LockTarget),
{
...
["localize ELSTRING(common,ACEConfigCategoryWeapons)", QGVAR(cycleFireMode), localize LSTRING(CycleFireMode),
{ false },
{
