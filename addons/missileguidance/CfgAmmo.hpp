class CfgAmmo {
    ...
    class M_Vorona_HEAT;
    class ACE_Metis_9M135_HEAT: M_Vorona_HEAT {
        manualControl = 0;
        irLock = 0;
        laserLock = 0;
        airLock = 0;
        ...
        class ADDON {
            ...
            correctionDistance = 25; // distance from center of crosshair where missile slows down
    ...
    class M_Vorona_HE;
    class ACE_Metis_9M135_HE: M_Vorona_HE {
        manualControl = 0;
        irLock = 0;
        laserLock = 0;
        airLock = 0;
        ...
        class ADDON {
            ...
            minDeflection = 0;          // Minium flap deflection for guidance
            maxDeflection = 0.0035;     // Maximum flap deflection for guidance
            incDeflection = 0.0005;     // The incrmeent in which deflection adjusts.
