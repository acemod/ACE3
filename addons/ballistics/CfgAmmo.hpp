...
class CfgAmmo {
    ...
    class B_12Gauge_Slug_NoCartridge: B_12Gauge_Slug { // Federal Law Enforcement Tactical TruBall Rifled Slug https://le.vistaoutdoor.com/ammunition/federal/slug/details.aspx?id=705
        ...
        // as reference https://www.youtube.com/watch?v=960nYuugzZo, Federal Slug (3000fps, 30"), unknown mesurement conditions, chronograph 5ft from muzzle
        ...
        ACE_muzzleVelocities[] = {340, 440, 477, 489, 517}; // Muzzle Velocities 70°F (21°C) +1m/s, 419m/s (317mm), 436m/s (349.7mm), 459m/s (457mm), 485m/s (699.3mm), 488m/s (3000fps, 30") ASM conditions (15°C, 999.916hPa, 78%)
        ...
        airFriction = -0.00571374; // B_12Gauge_Slug -0.008
    };
