...
class CfgMagazines {
    ...
    // Practice
    class ACE_30Rnd_556x45_Stanag_Practice: 30Rnd_556x45_Stanag {
        author = ECSTRING(common,ACETeam);
        ammo = "ACE_B_556x45_Practice";
        displayName = CSTRING(ACE_30Rnd_556x45_Stanag_PracticeName);
        displayNameShort = CSTRING(ACE_30Rnd_556x45_Stanag_PracticeNameShort);
        descriptionShort = CSTRING(ACE_30Rnd_556x45_Stanag_PracticeNameDescription);
        //picture = "\A3\weapons_f\data\ui\m_20stanag_red_ca.paa";
        picture = PATHTOF(UI\m_20stanag_practice_ca.paa);
        initSpeed = 640; //http://simunition.com/upload/documents/doc_95.pdf
    };
};
