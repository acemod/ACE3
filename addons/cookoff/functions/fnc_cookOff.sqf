...
[{
    params ["_vehicle", "_positions", "_intensity", "_ammoDetonationChance", "_detonateAfterCookoff"];
    _vehicle setVariable [QGVAR(intensity), _intensity];

    [{
        params ["_args", "_pfh"];
        _args params ["_vehicle", "_positions", "_ammoDetonationChance", "_detonateAfterCookoff"];
    ...
    }, 0.25, [_vehicle, _positions, _ammoDetonationChance, _detonateAfterCookoff]] call CBA_fnc_addPerFrameHandler
}, [_vehicle, _positions, _intensity, _ammoDetonationChance, _detonateAfterCookoff], _delay] call CBA_fnc_waitAndExecute;
