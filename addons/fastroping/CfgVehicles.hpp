...
class CfgVehicles {
    ...
    class Heli_Transport_02_base_F: Helicopter_Base_H {
        ...
        class UserActions {
            ...
            class Ramp_Close: Ramp_Open {
                condition = QUOTE([ARR_3(this,'CargoRamp_Open',[[0],[1],[2]])] call FUNC(canCloseRamp));
            };
        };
    };
    class Heli_Transport_03_base_F: Helicopter_Base_H {
        ...
        class UserActions {
            class Ramp_Open;
            class Ramp_Close: Ramp_Open {
                condition = QUOTE([ARR_3(this,'Door_rear_source',[[0],[3],[4]])] call FUNC(canCloseRamp));
            };
        };
    };
    ...
    class O_Heli_Transport_04_covered_F: Heli_Transport_04_base_F {
        ...
        class UserActions: UserActions {
            ...
            class Ramp_Close: CloseDoor_6 {
                condition = QUOTE([ARR_3(this,'Door_6_source',[[0],[1],[2],[3]])] call FUNC(canCloseRamp));
            };
        };
    };
    class NATO_Box_Base;
