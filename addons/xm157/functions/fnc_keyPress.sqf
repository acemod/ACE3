...
if (getText (_scope call CBA_fnc_getItemConfig >> "weaponInfoType") != "ace_xm157_info") exitWith { false }; // allow zeroing changes for muzzles not using a scope using the XM157 framework
