...
if (GVAR(correctZeroing) || GVAR(simplifiedZeroing)) then {
    ...
    private _zeroCorrection = missionNamespace getVariable format[QGVAR(%1_%2_%3_%4_%5_%6_%7_%8), _oldZeroRange, _newZeroRange, _boreHeight, _weapon, _muzzle, _ammo, _magazine, _advancedBallistics];
