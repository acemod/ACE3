...
// Add keybinds
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustUpMinor), localize LSTRING(AdjustUpMinor),
{
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustDownMinor), localize LSTRING(AdjustDownMinor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustLeftMinor), localize LSTRING(AdjustLeftMinor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustRightMinor), localize LSTRING(AdjustRightMinor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustUpMajor), localize LSTRING(AdjustUpMajor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustDownMajor), localize LSTRING(AdjustDownMajor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustLeftMajor), localize LSTRING(AdjustLeftMajor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
...
[localize ELSTRING(common,ACEConfigCategoryScopeAdjustment)
, QGVAR(AdjustRightMajor), localize LSTRING(AdjustRightMajor),
{
    // Conditions: canInteract
    if !([ACE_player, objNull, []] call EFUNC(common,canInteractWith)) exitWith {false};
    // Conditions: specific
