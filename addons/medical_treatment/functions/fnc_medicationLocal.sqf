...
private _maxSafeDose            = GET_NUMBER(_medicationConfig >> "maxSafeDose",getNumber (_defaultConfig >> "maxSafeDose"));
private _chanceDoses            = GET_NUMBER(_medicationConfig >> "chanceDoses",getNumber (_defaultConfig >> "chanceDoses"));
...
[_patient, _className, _maxSafeDose, _chanceDoses, _incompatibleMedication] call FUNC(onMedicationUsage);
