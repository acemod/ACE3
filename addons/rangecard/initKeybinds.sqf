[localize ELSTRING(common,ACEConfigCategoryEquipment), QGVAR(RangeCardDialogKey), localize "STR_ACE_RangeCard_RangeCardDialogKey",
{
...
[localize ELSTRING(common,ACEConfigCategoryEquipment), QGVAR(RangeCardCopyDialogKey), localize "STR_ACE_RangeCard_RangeCardCopyDialogKey",
{
