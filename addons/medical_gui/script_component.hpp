...
#define PATIENTINFO_IGUI_BASE_X (safeZoneX + POS_W(2))
#define PATIENTINFO_IGUI_BASE_Y (safeZoneY + POS_H(1))
#define PATIENTINFO_IGUI_X (profilenamespace getVariable ['TRIPLES(IGUI,GVAR(patientInfo),X)', 0])
#define PATIENTINFO_IGUI_Y (profilenamespace getVariable ['TRIPLES(IGUI,GVAR(patientInfo),Y)', 0])
#define PATIENT_INFO_IGUI_OFFSET_X (PATIENTINFO_IGUI_X - PATIENTINFO_IGUI_BASE_X)
#define PATIENT_INFO_IGUI_OFFSET_Y (PATIENTINFO_IGUI_Y - PATIENTINFO_IGUI_BASE_Y)
