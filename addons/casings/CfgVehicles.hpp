class CfgVehicles {
    ...
    class GVAR(FxCartridge_762): GVAR(FxCartridge) {
        model = QUOTE(PATHTOF(models\rocko_762.p3d));
    };
    class GVAR(FxCartridge_127): GVAR(FxCartridge) {
        model = QUOTE(PATHTOF(models\rocko_127.p3d));
    };
    class GVAR(FxCartridge_slug): GVAR(FxCartridge) {
        model = QUOTE(PATHTOF(models\rocko_sg.p3d));
    };
