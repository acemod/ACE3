class RscInGameUI {
    ...
    class ACE_Mk6_RscWeaponRangeArtillery: RscWeaponRangeArtillery {
        onLoad = QUOTE(uiNamespace setVariable [ARR_2('ACE_Mk6_RscWeaponRangeArtillery', _this select 0)]; [ARR_2('infoDisplayChanged', [ARR_2(_this select 0, 'Mk6Mortar')])]   call CFUNC(localEvent););
