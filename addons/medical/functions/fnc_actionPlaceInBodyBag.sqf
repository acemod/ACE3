...
if (!local _target) exitWith {
    ...
    ["actionPlaceInBodyBag", [_target], [_caller, _target]] call CFUNC(targetEvent);
    objNull
};
...
["placedInBodyBag", [_target, _bodyBag]] call CFUNC(globalEvent); //hide and delete body on server
