...
if (alive _target) exitWith {
    ...
    [_target, "activity", LSTRING(Activity_fullHeal), [[_caller, false, true] call CFUNC(getName)]] call FUNC(addToLog);
    [_target, "activity_view", LSTRING(Activity_fullHeal), [[_caller, false, true] call CFUNC(getName)]] call FUNC(addToLog); // TODO expand message
};
