...
[_target, "activity", LSTRING(Activity_CPR), [[_caller, false, true] call CFUNC(getName)]] call FUNC(addToLog);
[_target, "activity_view", LSTRING(Activity_CPR), [[_caller, false, true] call CFUNC(getName)]] call FUNC(addToLog); // TODO expand message
