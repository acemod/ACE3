class CfgAmmo {
    ...
    class rhssaf_mine_mrud_d_ammo: rhssaf_mine_mrud_a_ammo {
       EGVAR(explosives,defuseObjectPosition)[] = {0.0325, 0, 0.18};
    };

    class MineBase;
    class rhssaf_mine_pma3_ammo: MineBase {
       EGVAR(explosives,defuseObjectPosition)[] = {0, 0, 0.025};
    };

    class rhssaf_mine_tma4_ammo: MineBase {
       EGVAR(explosives,defuseObjectPosition)[] = {0, 0, 0.045};
    };
    ...
    class rhssaf_tm200_ammo: rhssaf_tm100_ammo {
       EGVAR(explosives,defuseObjectPosition)[] = {-0.055, 0, 0.018};
    };

    class rhssaf_tm500_ammo: rhssaf_tm100_ammo {
       EGVAR(explosives,defuseObjectPosition)[] = {-0.056, 0, 0.032};
    };
};
