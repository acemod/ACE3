...
if (_hitPointNewDamage < _hitPointCurDamage) then {
    ...
    ["setVehicleHitPointDamage", [_vehicle, _hitPointIndex, _hitPointNewDamage], _vehicle] call CBA_fnc_targetEvent;
        ...
        if (_masterHitpoint == _hitPointClassname) exitWith {
            {
                ...
                if (_subHitIndex == -1) then {
                    ...
                    if (_subPointNewDamage < _subPointCurDamage) then {
                        ...
                        ["setVehicleHitPointDamage", [_vehicle, _subHitIndex, _subPointNewDamage], _vehicle] call CBA_fnc_targetEvent;
                    };
                };
