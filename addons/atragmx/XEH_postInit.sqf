...
if (count (profileNamespace getVariable ["ACE_ATragMX_gunList", []]) > 0) then {
    ...
    GVAR(gunList) =  [["12.7x108mm"       , 820, 100, 0.0657, -0.0005600, 3.81, 0, 0.338, 0.338, 120, 0, 0, 48.28, "B_127x108_Ball"  , "5Rnd_127x108_Mag"        , 0.700, 1, "ASM" ],
                      ["12.7x99mm"        , 880, 100, 0.0599, -0.0005600, 3.81, 0, 0.338, 0.338, 120, 0, 0, 41.92, "B_127x99_Ball"   , "5Rnd_mas_127x99_Stanag"  , 0.670, 1, "ASM" ],
