...
// Rebels
BASE_PAIR(CUP_U_I_GUE_Flecktarn2,CUP_U_I_GUE_Flecktarn3); // Hood Up Down

// PMC
BASE_PAIR(CUP_I_B_PMC_Unit_30,CUP_I_B_PMC_Unit_29); // Hood Up Down
BASE_PAIR(CUP_I_B_PMC_Unit_27,CUP_I_B_PMC_Unit_26); // Hood Up Down
BASE_PAIR(CUP_I_B_PMC_Unit_25,CUP_I_B_PMC_Unit_18); // Hood Up Down
BASE_PAIR(CUP_I_B_PMC_Unit_34,CUP_I_B_PMC_Unit_33); // Hood Up Down
