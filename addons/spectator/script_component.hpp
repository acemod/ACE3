...
#define CTRL_FREE (SPEC_DISPLAY displayCtrl IDC_FREE)
#define IDC_FOLLOW 60007
#define CTRL_FOLLOW (SPEC_DISPLAY displayCtrl IDC_FOLLOW)
#define IDC_FPS 60008
#define CTRL_FPS (SPEC_DISPLAY displayCtrl IDC_FPS)
