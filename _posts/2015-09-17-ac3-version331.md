...
description: Test
parent: posts
image: /img/news/150917_twodudes.jpg
layout: post
---

Since we've started working on ACE3 3.3.0 it has seen major changes both feature and code wise. Using the new commands added in Arma 3 1.48 and 1.50 we've gone over the complete code base and touched nearly every file.
...
<div class="row">
    <div class="small-12 medium-6 columns">
        <img src="http://i.imgur.com/P6AQHRA.jpg" alt="A gift AGM got as part of being a finalist in the 'Make Arma Not War' contest"/>
    </div>
    <div class="small-12 medium-6 columns">
        <img src="http://i.imgur.com/MdXEmrC.jpg" alt="A gift CSE got as part of being a finalist in the 'Make Arma Not War' contest"/>
    </div>
</div>
...
If you want to chat with fellow ACE3 users or with a dev feel free to join our public slack chat. Registration is free and open for everyone: https://slackin.koffeinflummi.de/ (This url will change in the near future)
